...
and wrench feasibility span algebraic connectivities from $\approx0$ (below the required
margin) to $0.85$, while the WISE SDP certifies all $30$ paired cases and integer
recovery re-certifies $100\%$; the study separates wrench from communication
infeasibility and quantifies the heuristic attainment gap.
\end{abstract}
