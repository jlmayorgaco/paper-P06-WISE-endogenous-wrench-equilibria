...
$0.85$, while the relaxed WISE SDP certifies all $30$ paired cases; a single
randomized-rounding draw re-certifies $66\%$ of the integer assignments and up to $30$
draws re-certify all $30$. The study separates wrench from communication infeasibility
and quantifies the heuristic attainment gap.
\end{abstract}
