...
methods reconfigure the relay layer~\cite{santos2024backbone}. These impose a threshold or
repair the backbone directly, but do not characterize \emph{when} connectivity can rise within
the \emph{exact} productive-optimum fiber.
