...
\item \textbf{Finite-team transfer} (Proposition~\ref{prop:integer}): explicit wrench and
connectivity margins under which an integer recovery preserves both feasibilities, evaluated
by rounding on heterogeneous instances.
\end{itemize}
