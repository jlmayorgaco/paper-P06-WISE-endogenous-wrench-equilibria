...
lexicographically over that fiber, yielding a relaxed SDP existence certificate under hard
wrench constraints. \emph{Scope:} equilibrium-set geometry and centralized target selection,
not distributed Nash seeking; the game-theoretic content is how lost composition-level strong
monotonicity yields a set-valued VE whose neutral tangent directions are a network-design
resource.
