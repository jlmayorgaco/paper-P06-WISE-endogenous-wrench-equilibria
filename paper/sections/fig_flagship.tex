...
\begin{scope}
  \node[ptitle] at (2.35,5.75) {both $L$ lift: $\lambda_2\approx0$};
...
\begin{scope}[xshift=6.6cm]
  \node[ptitle] at (2.35,5.75) {WISE: one $L$ relays: $\lambda_2\ge\sigma_{\mathrm{req}}$};
  \drawload{1.0}{4.5}{0}\drawload{3.7}{4.5}{1}
...
\node[invbox] at (9.0,0.15) {%
  ...
  $\Delta Bz{=}\Delta V{=}0$, both wrench-feasible, $\Delta\lambda_2>0$};
\end{tikzpicture}
